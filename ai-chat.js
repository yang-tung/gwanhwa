...
const KNOWLEDGE_BASE = {
    ...
    news: [
        "2026年5月10日微信公众号发布《红筹架构上市公司商标权属规划研究——以瑞幸、奈雪、霸王茶姬、MiniMax为例》",
        "2026年4月4日微信公众号发布《悄无声息地商标淡化：Ai，是Adobe Illustrator，还是Artificial Intelligence？》",
        "2025年10月23日微信公众号发布《摹仿驰名商标的认定标准——巨硬（Macrohard）和微软（Microsoft）》",
        "2025年10月21日微信公众号发布《证券简称的不规范使用可构成商标侵权或不正当竞争》",
        "2025年7月15日微信公众号发布《潮流IP“Labubu”的前瞻性知识产权规划研究》"
    ],
    faq: {
